...
public class Child {
    ...
    public Child(String name, String address, String birth_place, String gender, String dob,
    ...
    public Child(int childId, String name, String address, String birthPlace, String gender, String dob, float birtHeight, float birtWeight, String note, String bloodType) {
